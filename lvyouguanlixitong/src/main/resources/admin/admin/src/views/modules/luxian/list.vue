        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lvyouguanlixitong/upload/luxianMuBan.xls"
                        >批量导入路线推荐数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('luxian','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="luxianUuidNumber"
                                   header-align="center"
                                   label="路线推荐编号">
                        <template slot-scope="scope">
                            {{scope.row.luxianUuidNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="luxianPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.luxianPhoto">
                                <img :src="$base.url+scope.row.luxianPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
