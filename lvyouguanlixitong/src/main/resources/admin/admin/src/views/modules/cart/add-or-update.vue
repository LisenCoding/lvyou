        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shangpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="美食" prop="shangpinId">
                        <el-select v-model="ruleForm.shangpinId" :disabled="ro.shangpinId" filterable placeholder="请选择美食" @change="shangpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食地点" prop="shangpinAddress">
                        <el-input v-model="shangpinForm.shangpinAddress"
                                  placeholder="美食地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食类型" prop="shangpinValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食热度" prop="shangpinClicknum">
                        <el-input v-model="shangpinForm.shangpinClicknum"
                                  placeholder="美食热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="美食热度" prop="shangpinClicknum">
