...
//                            shangpinOrderEntity.setShangpinId(Integer.valueOf(data.get(0)));   //美食 要改的
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            Integer shangpinId = Integer.valueOf(String.valueOf(map.get("shangpinId")));//美食id
            Integer buyNumber = Integer.valueOf(String.valueOf(map.get("buyNumber")));//购买数量
            ShangpinEntity shangpinEntity = shangpinService.selectById(shangpinId);//购买的美食
            ...
            shangpinOrderEntity.setShangpinId(shangpinId);//美食
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            shangpinService.updateById(shangpinEntity);//更新订单中美食的信息
