        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '美食名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="美食名称" clearable></el-input>
                     </el-form-item>
                                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '美食类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择美食类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lvyouguanlixitong/upload/shangpinMuBan.xls"
                        >批量导入美食数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="shangpinAddress"
                                   header-align="center"
                                   label="美食地点">
                        <template slot-scope="scope">
                            {{scope.row.shangpinAddress}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="zanNumber"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">增加美食库存</el-button>-->
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">减少美食库存</el-button>-->
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '美食名称': "shangpinName",
                     '美食编号': "shangpinUuidNumber",
                     '美食照片': "shangpinPhoto",
                     '美食地点': "shangpinAddress",
                     '赞': "zanNumber",
                     '踩': "caiNumber",
                     '美食类型': "shangpinValue",
                     '美食库存': "shangpinKucunNumber",
                     '金额': "shangpinNewMoney",
                     '美食热度': "shangpinClicknum",
                     '录入时间': "insertTime",
            },
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shangpinKucunNumberTitle = '增加美食库存'
			},
			//减少美食库存
			...
			//数据不为空放值
				...
				this.shangpinKucunNumberVisible = true;
				//标题
				this.shangpinKucunNumberTitle = '减少美食库存'
			},
			//提交用户操作美食库存数量
